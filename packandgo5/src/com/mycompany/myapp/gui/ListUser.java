...
public class ListUser extends BaseForm {
    ...
    public ListUser(Resources res) {
        ...
        //System.out.println("user connecté username =" + SessionManager.getallUsers());
...
//        rbs[0].setSelected(true);
        ...
        RadioButton mesListes = RadioButton.createToggle("Mes Liste", barGroup);
...
//                );
    ...
    private void addButton(Image img, User rec, Resources res) {
        ...
        Label objetTxt = new Label("email : " + rec.getEmail(), "NewsTopLine2");
        Label dateTxt = new Label("FirstName : " + rec.getFirstName(), "NewsTopLine2");
        Label etatTxt = new Label("LastName : " + rec.getLastName(), "NewsTopLine2");
...
//        }
        ...
        lSupprimer.addPointerPressedListener(l -> {
            ...
            if (ServiceUser.getInstance().deleteUser(rec.getId())) {
